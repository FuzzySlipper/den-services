...
func NewHTTPServer(cfg *Config, buildInfo health.BuildInfo, service KnowledgeUseCases) (*http.Server, error) {
	...
	return &http.Server{Addr: cfg.BindAddr, Handler: root, ReadHeaderTimeout: cfg.HTTP.ReadHeaderTimeout}, nil
}
