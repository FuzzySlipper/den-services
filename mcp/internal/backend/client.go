...
func (c *Client) Call(ctx context.Context, backend config.BackendConfig, route Route, call ToolCall) (Result, *Failure, error) {
	...
	case route.RequestAdapter == RequestAdapterMCPMessagesREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callMessagesREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPDocumentsREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callDocumentsREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPReviewREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callReviewREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPKnowledgeREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callKnowledgeREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPGuidanceREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callGuidanceREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPLibrarianREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
		return c.callLibrarianREST(ctx, backend, route, call)
	case route.RequestAdapter == RequestAdapterMCPHandoffREST && route.ResponseAdapter == ResponseAdapterMCPToolResultJSON:
