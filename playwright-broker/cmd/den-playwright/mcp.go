...
func playtestTools() []map[string]any {
	...
	return []map[string]any{
		{
			"name":        "playtest_start",
			"description": "Start a permissive persistent Playwright session. Set verbose_trace=true for optional concise decision tracing. Optional field_guide and source_handles inputs are frozen in evidence; all extra fields are retained as metadata.",
